...
namespace GPI
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 18; i++)
            {
                if (ptscomps[i] > max && cargospre[0] != i && cargospre[1] != i)
                {
                    max = ptscomps[i];
                    cargospre[2] = i;
                }
            ...
            if (ptscomps[1] > 0)
                ...
                label50.Text = "";
            if (ptscomps[2] > 0)
                label49.Text = nomcargos[2] + " con " + ptscomps[cargospre[2]] + " pts en Competencias y " + ptshabs[cargospre[2]] + " pts en habilidades";
            else
                label49.Text = "";
            double[] poderaciones = new double[3];
            for (int i = 0; i < 3; i++)
            {
                poderaciones[i] = ptscomps[cargospre[i]] * 0.6 + ptshabs[cargospre[i]] * 0.4;
            }
